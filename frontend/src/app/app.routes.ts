...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'agricultores', loadComponent: () => import('./pages/agricultores/agricultores-list.component').then((m) => m.AgricultoresListComponent) },
      ...
      { path: 'cultivos/nuevo', canActivate: [roleGuard('administrador', 'tecnico')], loadComponent: () => import('./pages/cultivos/cultivo-form.component').then((m) => m.CultivoFormComponent) },
      { path: 'cultivos/:id/editar', canActivate: [roleGuard('administrador', 'tecnico')], loadComponent: () => import('./pages/cultivos/cultivo-form.component').then((m) => m.CultivoFormComponent) },
      { path: 'lotes', loadComponent: () => import('./pages/lotes/lotes-list.component').then((m) => m.LotesListComponent) },
      { path: 'lotes/nuevo', canActivate: [roleGuard('administrador', 'tecnico')], loadComponent: () => import('./pages/lotes/lote-form.component').then((m) => m.LoteFormComponent) },
      { path: 'lotes/:id/editar', canActivate: [roleGuard('administrador', 'tecnico')], loadComponent: () => import('./pages/lotes/lote-form.component').then((m) => m.LoteFormComponent) },
